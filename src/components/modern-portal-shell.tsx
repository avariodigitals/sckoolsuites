            ...
            <div className="flex items-center gap-1 sm:gap-2 lg:gap-3">
              ...
              <div className="relative pl-2 sm:pl-3 lg:border-l lg:border-slate-200" ref={userMenuRef}>
                ...
                >
                  ...
                  <div className="h-9 w-9 rounded-full flex items-center justify-center font-semibold overflow-hidden ring-2 ring-transparent transition group-hover:ring-slate-200" style={{ backgroundColor: `${primaryColor ?? "#0B1F4D"}20`, color: primaryColor ?? "#0B1F4D" }}>
                    {avatarUrl ? (
                      // eslint-disable-next-line @next/next/no-img-element
