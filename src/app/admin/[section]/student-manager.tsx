    ...
    <div className="space-y-4">
      ...
      <div className="rounded-xl border border-slate-200 bg-white p-4">
        ...
        {filteredStudents.length === 0 ? (
          <p className="py-4 text-center text-sm text-slate-500">No students found.</p>
        ) : (
          <>
            {/* Desktop table */}
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <div className="mt-1.5 flex flex-wrap gap-x-3 gap-y-0.5 text-xs text-slate-600">
                        ...
                        <span>{student.dateOfBirth ? calcDetailedAge(student.dateOfBirth) : `${student.age} yrs`}</span>
                      </div>
                      {student.parentName && (
                        <p className="mt-0.5 truncate text-xs text-slate-500">Parent: {student.parentName}</p>
                      )}
                    </div>
                  </div>
