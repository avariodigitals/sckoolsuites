              ...
              <Card key={child.id} className="glass-panel overflow-hidden rounded-2xl border border-slate-200/70">
                ...
                <CardContent className="space-y-4 p-5 text-sm">
                    ...
                    <details className="overflow-hidden rounded-xl border border-slate-200" open>
                      <div className="flex items-center justify-between border-b border-slate-200 bg-slate-50 px-3 py-2">
                        ...
                        <div className="flex items-center gap-2">
                          <a href={getCloudinaryInlineUrl(latest.fileUrl)} target="_blank" rel="noopener noreferrer" className="rounded-md bg-slate-900 px-3 py-1 text-[11px] font-medium text-white hover:bg-slate-800">Download</a>
                  ...
                  <div className="flex flex-wrap justify-end gap-3">
                    {isUploadedPdf && latest?.fileUrl && (
                      <a href={getCloudinaryInlineUrl(latest.fileUrl)} target="_blank" rel="noopener noreferrer" className="rounded-md border border-slate-300 bg-white px-3 py-2 text-xs font-medium text-slate-700 hover:bg-slate-50">Download PDF</a>
                    )}
