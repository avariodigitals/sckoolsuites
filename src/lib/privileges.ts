...
export const ALL_PRIVILEGES = [
  ...
  { code: "results.approve", name: "Approve Results", category: "results" },
  // Assessments
...
/**
 * Maps admin section slugs (used in /admin/[section]) to the privilege
 * code required to view that section. Only users with the mapped privilege
 * should be able to access the corresponding admin page.
 */
export const SECTION_PRIVILEGE_MAP: Record<string, PrivilegeCode> = {
  ...
  complaints: "announcements.view",
  transport: "transport.view",
  "school-calendar": "sessions.view",
  surveys: "announcements.view",
...
/**
 * Set of privilege codes that grant access to the admin portal at all.
 * A user with any of these privileges can enter /admin/* — but individual
 * sections are still gated by SECTION_PRIVILEGE_MAP above.
 */
export const ADMIN_PORTAL_PRIVILEGES: PrivilegeCode[] = [
  "students.view",
  "parents.view",
  "teachers.view",
  "classes.view",
