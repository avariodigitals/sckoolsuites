  ...
  SUPER_ADMIN: [
    { label: "Dashboard", href: "/admin/dashboard", icon: LayoutDashboard, group: "1. Admin" },
    {
      ...
      children: [
        ...
        { label: "Surveys", href: "/admin/surveys", icon: ClipboardList, isSubmenu: true },
    ...
    },
    {
      ...
      group: "1. Admin",
      children: [
        { label: "Parent Records", href: "/admin/parents", icon: Users, isSubmenu: true },
        { label: "Messages", href: "/admin/messages", icon: Mail, isSubmenu: true },
        { label: "Complaints", href: "/admin/complaints", icon: MessageSquareWarning, isSubmenu: true },
        { label: "Payment Follow-up", href: "/admin/debtors", icon: FileBarChart, isSubmenu: true },
      ],
    },
    {
      label: "Teachers",
      ...
      group: "1. Admin",
      children: [
        { label: "Staff Directory", href: "/admin/teachers", icon: Users, isSubmenu: true },
        { label: "Lesson Plans", href: "/admin/lms", icon: BookOpen, isSubmenu: true },
        { label: "Subject Assignments", href: "/admin/subjects", icon: BookOpen, isSubmenu: true },
        { label: "Attendance", href: "/admin/attendance", icon: CalendarCheck, isSubmenu: true },
        { label: "Staff Clock-In", href: "/admin/staff-attendance", icon: CalendarCheck, isSubmenu: true },
      ],
    },
    ...
    },
    {
      ...
      group: "5. Access",
      children: [
        { label: "Users", href: "/admin/users", icon: UserCog, isSubmenu: true },
    ...
    },
    {
      ...
      children: [
        ...
        { label: "Bulk Import", href: "/admin/settings#bulk-import", icon: FileCheck, isSubmenu: true },
  ...
  SCHOOL_ADMIN: [
    ...
    },
    {
      ...
      children: [
        ...
        { label: "Bulk Import", href: "/admin/settings#bulk-import", icon: FileCheck, isSubmenu: true },
        { label: "Branding", href: "/admin/settings/branding", icon: Palette, isSubmenu: true },
        { label: "Data Purge", href: "/admin/settings#data-purge", icon: Trash2, isSubmenu: true },
        { label: "My Profile", href: "/admin/profile", icon: UserCog, isSubmenu: true },
      ],
    },
  ],
